...
describe('Type Guards', () => {
  ...
  describe('isFeedItem', () => {
    ...
    it('should validate FeedItem with optional fields', () => {
      const validItem = {
        ...
        categories: 'tech,news',
        enclosures: [
          { url: 'https://example.com/audio.mp3', type: 'audio/mp3', length: '12345' }
        ],
        thumbnail: 'https://example.com/thumb.jpg',
        thumbnailColor: { r: 255, g: 255, b: 255 },
        thumbnailColorComputed: '#ffffff',
  ...
  describe('validateType', () => {
    ...
    it('should throw on validation failure', () => {
      ...
      expect(() => validateType(data, isApiError, 'ApiError')).toThrow('Invalid ApiError: validation failed')
    })
  })
  ...
  describe('safeParse', () => {
    ...
    it('should return error result for invalid data', () => {
      ...
      if (result.success === false) {
        ...
        expect(result.error.message).toBe('Invalid ApiError: validation failed')
      }
    })
  })
})