...
The apps and API server must not be used for any unlawful purpose, including sending unsolicited emails, malware, viruses, illegal content, spam, or any content that infringes on others' rights.
All use must also comply with applicable law and the terms of service of your email and hosting providers.
