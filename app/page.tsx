...
const features = [
  ...
  },
  {
    ...
    description:
      "No recomendations, no tracking, no ads. Forever. Just you and content you love.",
  ...
  },
  {
    ...
    description:
      "Import/Export your subscriptions and take them wherever you go",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Native Digests apps are on the way for your preferred platform.
                Windows Alpha is available now. More platforms coming soon.
              </p>
            </div>
