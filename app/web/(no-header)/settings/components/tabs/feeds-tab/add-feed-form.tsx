...
import { useFeedForm } from "@/app/web/(no-header)/settings/hooks/use-feed-form";
...
interface AddFeedFormProps {
  feedUrlInputRef?: RefObject<HTMLInputElement | null>;
}

export const AddFeedForm = memo(function AddFeedForm({ feedUrlInputRef }: AddFeedFormProps) {
