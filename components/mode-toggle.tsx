...
export function ModeToggle() {
  ...
  const colorSchemes = Array.from(new Set(themes.map((t) => t.name.split("-")[0])));
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem
          onClick={() =>
            currentScheme ? setThemeWithScheme("light", currentScheme) : setTheme("light")
          }
        ...
        <DropdownMenuItem
          onClick={() =>
            currentScheme ? setThemeWithScheme("dark", currentScheme) : setTheme("dark")
          }
          className="flex justify-between items-center"
        >
          <div className="flex items-center gap-2">
              ...
              <AccordionContent className="pt-1">
                {colorSchemes.map((scheme) => {
                  ...
                  return (
                    <DropdownMenuItem
                      key={scheme}
                      onClick={() => setThemeWithScheme(isDark ? "dark" : "light", scheme)}
