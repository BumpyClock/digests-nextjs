...
export function PodcastDetailsModal({
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title={podcast.title}>
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              <PodcastMetadata
                ...
                duration={
                  podcast.duration ||
                  (podcast.enclosures?.[0]?.length
                    ? parseInt(podcast.enclosures[0].length)
                    : undefined)
                }
                author={
                  podcast.author
                    ? cleanupTextContent(podcast.author)
                    : undefined
                }
                variant="compact"
                className="mb-6"
