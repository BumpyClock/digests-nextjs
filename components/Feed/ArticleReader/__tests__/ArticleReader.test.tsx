...
describe('ArticleReader', () => {
  ...
  it('handles fetch errors gracefully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Failed to fetch article content/i)).toBeInTheDocument();
    });
  });
  ...
  it('renders article header image when available', () => {
    ...
    expect(headerImage).toHaveAttribute('src', expect.stringContaining('example.com/image.jpg'));
  });
