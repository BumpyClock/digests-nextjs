...
describe("ArticleReader", () => {
  ...
  describe("Rendering", () => {
    it("should render article content", () => {
      ...
      // Title
      expect(
        screen.getByText("Understanding Modern Web Development"),
      ).toBeInTheDocument();
  ...
  describe("Error Handling", () => {
    it("should handle missing content gracefully", () => {
      ...
      render(
        <ArticleReader article={articleWithoutContent} onClose={jest.fn()} />,
      );
    ...
    it("should handle malformed HTML", () => {
      ...
      render(
        <ArticleReader article={articleWithBadHTML} onClose={jest.fn()} />,
      );
