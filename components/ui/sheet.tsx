...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-overlay bg-overlay data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
...
const sheetVariants = cva("fixed z-modal gap-4 bg-background p-6 shadow-lg", {
  variants: {
    side: {
