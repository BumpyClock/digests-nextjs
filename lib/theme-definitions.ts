/**
 * Theme definitions for the digests-nextjs application
 * This file contains all the theme definitions used in the application
 */

/**
 * Core colors interface representing the semantic color tokens
...
export interface CoreColors {
  ...
  magentaPrimary: string;
  magentaSecondary: string;
}

/**
 * Theme definition interface representing a complete theme
 */
...
/**
 * Flexoki Light theme
 * Based on the current light theme in app/globals.css
 */
const flexokiLight: ThemeDefinition = {
  name: "flexoki-light",
...
/**
 * Flexoki Dark theme
 * Based on the current dark theme in app/globals.css
 */
const flexokiDark: ThemeDefinition = {
  name: "flexoki-dark",
 ...
 */
const standardLight: ThemeDefinition = {
  name: "standard-light",
 ...
 * Standard Dark theme
 */
const standardDark: ThemeDefinition = {
  name: "standard-dark",
