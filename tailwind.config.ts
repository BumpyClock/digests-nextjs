  ...
  theme: {
    extend: {
      ...
      transitionDuration: {
        ...
        slow: "var(--motion-duration-slow, 320ms)",
        slower: "var(--motion-duration-slower, 480ms)",
      },
      transitionTimingFunction: {
        standard: "var(--motion-ease-standard, cubic-bezier(0.2, 0, 0, 1))",
        emphasized: "var(--motion-ease-emphasized, cubic-bezier(0.2, 0, 0, 1.2))",
        decelerate: "var(--motion-ease-decelerate, cubic-bezier(0, 0, 0, 1))",
