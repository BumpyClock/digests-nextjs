...
export const createMockArticle = (overrides?: Partial<Article>): Article => ({
  ...
  status: 'success',
  content: '<h1>Test Article</h1><p>This is the full content of the test article with <strong>HTML formatting</strong>.</p>',
  title: 'Test Article Title',
  siteName: 'Test Site',
  image: 'https://example.com/thumbnail.jpg',
  favicon: 'https://example.com/favicon.ico',
  textContent: 'Test Article. This is the full content of the test article with HTML formatting.',
  markdown: '# Test Article\n\nThis is the full content of the test article with **HTML formatting**.',
  ...overrides,
});

// Batch creation utilities
export const createMockFeeds = (count: number, overrides?: Partial<Feed>): Feed[] => {
...
export const createMockFeedItems = (count: number, feedUrl: string = 'https://example.com/feed.xml', overrides?: Partial<FeedItem>): FeedItem[] => {
  return Array.from({ length: count }, (_, i) => 
    createMockFeedItem({
      id: `item-${i + 1}`,
      feedUrl,
...
export const createMockArticles = (count: number, overrides?: Partial<Article>): Article[] => {
  return Array.from({ length: count }, (_, i) => 
    createMockArticle({
      title: `Test Article ${i + 1}`,
...
export const createMockApiResponse = <T>(data: T, options?: { status?: number; headers?: Record<string, string> }) => ({
  ok: true,
