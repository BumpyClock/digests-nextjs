Digests is a RSS Reader and Podcast Player built with React. It is designed to be simple, fast, and easy to use. It supports both RSS and Atom feeds, and it can also play podcasts.
