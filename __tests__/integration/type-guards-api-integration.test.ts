...
describe('Type Guards + API Integration', () => {
  ...
  describe('Response Transformation', () => {
    it('should transform podcast feed with type validation', async () => {
      ...
      const result = await apiService.fetchFeeds(['https://example.com/podcast.xml']);
  ...
  describe('Cache Validation', () => {
    it('should validate cached data with type guards', async () => {
      ...
      jest.spyOn((apiService as any).cache, 'get').mockResolvedValueOnce(cachedData);
    ...
    it('should reject invalid cached data', async () => {
      ...
      jest.spyOn((apiService as any).cache, 'get').mockResolvedValueOnce(invalidCachedData);
